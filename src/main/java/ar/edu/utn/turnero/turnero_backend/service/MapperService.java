...
public class MapperService {
    ...
    public PrecioHorarioResponse toPrecioHorarioResponse(PrecioHorario p) {
        return PrecioHorarioResponse.builder()
                .id(p.getId())
                .canchaId(p.getCancha().getId())
    ...
    public CanchaResponse toCanchaResponse(Cancha c) {
        List<PrecioHorarioResponse> preciosHorarios = c.getPreciosHorarios() != null
                ? c.getPreciosHorarios().stream()
                .map(this::toPrecioHorarioResponse)
        ...
        return CanchaResponse.builder()
                ...
                .tienePreciosHorarios(!preciosHorarios.isEmpty())
                .preciosHorarios(preciosHorarios)
                .activa(c.isActiva())
    ...
    public PredioResponse toPredioResponse(Predio p) {
        return PredioResponse.builder()
                ...
                .horariosDisponibles(p.getHorariosDisponibles() != null
                        ? p.getHorariosDisponibles().stream()
